...
const URL = `${API_PREFIX}/project`;
const STAFF_URL = "/cloud/ums/staff/mini/getStaffListByConditions.smvc";
...
export const projectService = {
  ...
  getStaffListByConditions(params) {
    return http.post(STAFF_URL, { body: JSON.stringify(params || {}) });
  },
  loadStaffTree() {
